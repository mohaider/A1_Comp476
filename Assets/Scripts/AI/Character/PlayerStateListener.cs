...
public class PlayerStateListener : MonoBehaviour
{
    ...
    private PlayerStateController.PlayerState previousState = PlayerStateController.PlayerState.idle;//previous state
    private PlayerStateController.PlayerState currentState = PlayerStateController.PlayerState.idle; //current state
    [SerializeField]
    ...
    void OnStateChange(PlayerStateController.PlayerState newPlayerState)
    {
    ...
    /// <param name="playerState"></param>
    /// <returns></returns>
    bool CheckValidStatePairing(PlayerStateController.PlayerState newPlayerState)
    {
        bool returner = false;
    ...
    private bool CheckIfAbortState(PlayerStateController.PlayerState newPlayerState)
    {
        ...
        switch (newPlayerState)
        {
            ...
            case PlayerStateController.PlayerState.throwItem:
                float nextAllowedThrowItem = PlayerStateController.stateDelayTimer[(int)PlayerStateController.PlayerState.throwItem];
